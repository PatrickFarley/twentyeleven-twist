<?php
/**
 * custom Header template for blog pages
 *
 * Displays all of the <head> section and everything up till <div id="main">.
 * NOTE: this header adds the "blog" class to the <body> element, so that all elements
 * within it can inherit the "blog" class (and be targeted appropriately in the 
 * style.css file)
 *
 */
?><!DOCTYPE html>
...
<!-- adding class 'blog' to the other classes of the body element -->
